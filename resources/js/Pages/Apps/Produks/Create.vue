...
export default {
  ...
  //composition API
  setup() {
    //focus on barcode input when component is mounted
    onMounted(() => {
      focused("barcode");
    });

    //define focused function
    ...
    const submit = () => {
      ...
      router.post(
        "/apps/produks",
        {
          ...
          kategori: kategoriID.value ? kategoriID.value.id : "",
          nama_produk: form.nama_produk,
          keterangan: form.keterangan,
          harga_beli: form.harga_beli == 0 ? "" : form.harga_beli,
          harga_jual: form.harga_jual == 0 ? "" : form.harga_jual,
          stok: form.stok,
        },
        {
          onSuccess: () => {
            Swal.fire(
              {
                title: "Berhasil!",
                text: `Produk ${form.nama_produk} berhasil ditambahkan.`,
                icon: "success",
