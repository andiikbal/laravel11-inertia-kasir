<template>
  <Head>
    <title>Edit Kategori - Aplikasi Kasir</title>
  </Head>
  <main class="c-main">
            ...
            <div class="card border-0 rounded-3 shadow border-top-purple">
              <div class="card-header">
                <span class="font-weight-bold">
                  <i class="fa fa-user"></i> EDIT KATEGORI
                </span>
              </div>
              <div class="card-body">
...
export default {
  ...
  setup(props) {
    ...
    const form = reactive({
      nama_kategori: props.kategori.nama,
      keterangan:
        props.kategori.keterangan == null ? "" : props.kategori.keterangan,
    });
    ...
    const submit = () => {
      ...
      //send data to server
      router.put(
        `/apps/kategoris/${props.kategori.id}`,
        {
    ...
    const reset = () => {
      router.get(`/apps/kategoris/${props.kategori.id}/edit`);
    };
