            ...
            <div class="card border-0 rounded-3 shadow border-top-purple">
              <div class="card-header">
                <span class="font-weight-bold">
                  <i class="fa fa-shopping-bag"></i> TAMBAH PELANGGAN
                </span>
              </div>
              <div class="card-body">
                <form @submit.prevent="submit">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea
                      ...
                      rows="4"
                      placeholder="Alamat"
                      @keypress.enter.prevent="focused()"
                    ></textarea>
                  </div>
                  <div
                    v-if="errors.alamat"
...
export default {
  ...
  setup() {
      ...
      router.post(
        ...
        },
        {
          onSuccess: () => {
            Swal.fire({
              title: "Berhasil!",
              text: `Pelanggan ${form.nama_lengkap} berhasil ditambahkan.`,
              icon: "success",
    ...
    const reset = () => {
      router.get("/apps/pelanggans/create");
    };
