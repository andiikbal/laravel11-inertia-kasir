<template>
  <Head>
    <title>Tambah Pengguna - Aplikasi Kasir</title>
  </Head>
  <main class="c-main">
              ...
              <div class="card-body">
                <form @submit.prevent="submit">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="mb-3">
                        <label class="fw-bold">Peran</label>
                        <br />
                        <div
                          v-if="errors.peran"
                          class="alert alert-danger py-2"
    ...
    const submit = () => {
      router.post(
        "/apps/penggunas",
        {
          ...
          alamat_email: form.alamat_email.trim(),
          kata_sandi: form.kata_sandi.trim(),
          kata_sandi_confirmation: form.konfirmasi.trim(),
          peran: form.perans,
        },
        {
          onSuccess: () => {
